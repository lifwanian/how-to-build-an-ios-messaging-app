...
**User ID** is used to identify users in your application. This project uses the device ID(IDFV) for it. If there isn’t the user which has the user ID, JIVER will create the user with the ID.
